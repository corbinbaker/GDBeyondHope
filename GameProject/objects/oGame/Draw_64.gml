...
draw_sprite(sBulletGUI,0,view_wport[0]-50,50);						// draw the star sprite
draw_text(view_wport[0]-20-sprite_get_width(sBulletGUI),57,oPlayer.weaponAmmo[oPlayer.weapon]);	// draw the number of stars collected
}
